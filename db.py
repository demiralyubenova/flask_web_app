...
with app.app_context():
    ...
    i4 = Item(name="Pizza",description="ingredians: peperoni,cheese,tomato sauce,dough", barcode = "123456789015", price = 6)
    i5 = Item(name="Kebab",description="ingredians: chicken,salad,tomato,tortilla,garlic sauce", barcode = "123456789016", price = 5)
    i6 = Item(name="Kebb",description="ingredias: chicken,salad,tomato,tortilla,garlic sauce", barcode = "123456789017", price = 8, owner = "Joji")
